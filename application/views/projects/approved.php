	            ...
	            <?php $i = 1; ?>
                  ...
                  <?php if($this->session->userdata('user_id') == $project['user_id'] || $this->session->userdata('user_role') == 'admin' || $this->session->userdata('user_id') == $project['sv_id']): ?>
                    ...
                    <?php echo form_open('projects/approve/' .$project['project_id']); ?>
                      ...
                      <a class="btn btn-primary" href="<?php echo site_url('/projects/videograph/' .$project['slug']); ?>" style="margin:5px">Check Feedback</a>
                    <?php endif;?>
                    <?php if(($project['category_name'] == 'Web')): ?>
                      <a class="btn btn-primary" href="<?php echo site_url('/projects/webgraph/' .$project['slug']); ?>" style="margin:5px">Check Feedback</a>
                    <?php endif;?>
                    <?php if(($project['category_name'] == 'Game')): ?>
                      <a class="btn btn-primary" href="<?php echo site_url('/projects/gamegraph/' .$project['slug']); ?>" style="margin:5px">Check Feedback</a>
                    <?php endif;?>
                  ...
                  <?php if (($i==1)): ?>
                  <tr>
                    <td style="text-align:center;" colspan="6"><?php echo 'No approved projects!'; ?></td>
                  </tr>
                  <?php endif; ?>
            </tbody>
          </table>
